...
- `بانكاي [ID أو منشن]` — طرد وإضافة العضو كل 4 ثوانٍ
- `بانكاي ايقاف` — إيقاف بانكاي وإرسال رسالة التأكيد
- `قصف / قصف ايقاف`
- `كاتش / مجموعة / جروب`
- `تثبيت` — بالرد على صورة، يثبتها كصورة للمجموعة ويعيدها تلقائياً بعد 3 ثوانٍ إذا تغيّرت
- `تثبيت ايقاف` — إيقاف تثبيت الصورة وإلغاء الحماية
- `رد [كلمة]» [رد]`
- `يوت [اسم المقطع]`
